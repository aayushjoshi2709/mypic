...
func (repository *Repository) GetAll(ctx *gin.Context, groupId string, page, limit int64) ([]Image, error) {
	userId, _ := ctx.Get("userId")
...
func (repository *Repository) GetCount(ctx *gin.Context, groupId string) (int64, error) {
	userId, _ := ctx.Get("userId")
